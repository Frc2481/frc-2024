...
class AngulatorSubsystem(commands2.SubsystemBase):
    ...
    def __init__(self):
        ...
        self.angulatorMotor.configForwardSoftLimitThreshold(constants.kAngulatorForwardSoftLimitRot)
        self.angulatorMotor.configReverseSoftLimitThreshold(constants.kAngulatorReverseSoftLimitRot)
