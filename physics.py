...
class PhysicsEngine:
    ...
    def __init__(self, physics_controller: PhysicsInterface, robot: "MyRobot"):
        ...
        self.angulator_motor_sim = DCMotorSim(DCMotor.krakenX60(1), constants.kAngulatorGearReduction, 0.001)
    ...
    def update_sim(self, now: float, tm_diff: float) -> None:
        ...
        self.shooter_adjust.setAngle(self.robot.container.angulator.angulatorMotor.get_position().value)
        self.feeder_adjust.setAngle(self.robot.container.angulator.angulatorMotor.get_position().value)
